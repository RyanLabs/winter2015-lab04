...
class Order extends Application {
    ...
    function display_menu($order_num = null) {
        ...
        $this->data['title'] = "Order # " . $order_num . sprintf(" (%.2f)",$this->orders->total($order_num));;
    ...
    function commit($order_num) {
        ...
        $this->orders->update($record); // update the orders with this record
    ...
    function cancel($order_num) {
        ...
        $record = $this->orders->get($order_num);
        $record->status = 'x'; // incomplete or cancelled
